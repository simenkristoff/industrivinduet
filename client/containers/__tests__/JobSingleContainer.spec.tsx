...
describe('container <JobSingleContainer />', () => {
  ...
  it('should render both container and component', () => {
    ...
    container = wrapper.find(JobSingleContainer);
    component = container.find(JobSingle);
  ...
  it('should fetch data on mount', () => {
    ...
    expect(actions[0][0]['type']).toBe(JobActionTypes.FETCH_ONE.START);
    wrapper.unmount();
  });
  ...
  it('should clear data on unmount', () => {
    ...
    expect(actions[0][0]['type']).toBe(JobActionTypes.FETCH_ONE.START);
    expect(actions[1][0]['type']).toBe(JobActionTypes.SET.START);
  });
});
