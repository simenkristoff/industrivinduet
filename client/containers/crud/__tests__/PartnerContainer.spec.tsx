...
describe('container <PartnerContainer />', () => {
  ...
  beforeEach(() => {
    ...
    container = wrapper.find(PartnerContainer);
  ...
  it('should fetch data on mount', () => {
    ...
    expect(
      actions.some((action) => action[0]['type'] === PartnerActionTypes.FETCH.START),
    ).toBeTruthy();
  });
});
