        ...
        <Row gutter={[16, 16]} align='stretch' justify='center'>
          <Col md={12} span={24}>
            <section className='jobs full-height'>
              <div className='section-header section-img'>
        ...
        <Row gutter={[8, 8]} justify='start'>
          <Col md={12} span={24}>
            {nonOccupied.length > 0 && (
              <Col span={24}>
                <section className='non_occupied-count text-center section-img'>
                  <div className='section-header'>
          ...
          <Col md={12} span={24}>
            <Col span={24}>
              <section className='leaders text-center section-img'>
                <div className='section-header'>
                  <h4 className='section-title'>Ledere</h4>
                </div>
                <div className='section-content'>
                  {leaders.map((leader) => {
                    const leaderType = leader.role?.group
                      ? leader.role?.group?.name
                      : 'Daglig leder';
