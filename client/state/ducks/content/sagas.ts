...
/**
 * Handle async GET request to API for fetching Contents.
...
/**
 * Handle async POST request to API for creating a new Content.
...
/**
 * Handle async PUT request to API for updating a Content.
 * @param {IPayloadMetaAction<ContentEntity>} params action with payload and meta data.
 */
...
/**
 * Handle async DELETE request to API for deleting a Content.
 * @param {IPayloadMetaAction<ContentEntity>} params action with payload and meta data.
 */
